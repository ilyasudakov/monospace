...
- ### [Improvado](https://improvado.io)
  - #### <span>Младший Продуктовый Менеджер</span> <span>_Санкт-Петербург_, Дек 2024 - сейчас</span>
    - Анализ и подготовка фичей, их сопровождение во время разработки
    - Сам создавал большинство прототипов в Figma, Bolt.new (живые прототипы на React+Ant Design)
    - Работа с командой дизайнеров, разработчиков
  - #### <span>Бизнес-аналитик/Технический писатель</span> <span>_Санкт-Петербург_, Ноя 2023 - Дек 2024</span>
